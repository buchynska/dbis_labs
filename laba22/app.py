...
from forms.user_form import StudentForm, DisciplineForm, PostForm, DisciplineForm1, StudentForm1, PostForm1
...
if ENV == 'dev':
    app.debug = True
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:12345@localhost/NoSQL'
else:
    app.debug = False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://zjxszpttpiukoz:0396536d776f78fe2112b9d6cb05563141c88fb14a331de879c039c13d28b162@ec2-174-129-253-162.compute-1.amazonaws.com:5432/d6oqt898roh5dc'
